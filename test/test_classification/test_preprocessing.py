...
class TestPreprocessing(unittest.TestCase):
    ...
    test_phrase = "'You have probably never heard " + \
    ...
    def test_only_lowercased_letters_phrase(self):
        expected_phrase = [
            "you", "have", "probably", "never", "heard", "of",
            "professor", "moriarty", "said", "he"]
        actual_phrase = self.preprocessing.only_lowercased_letters(
            self.test_phrase)
    ...
    def test_stop_words_removal(self):
        ...
        lowercase_phrase = self.preprocessing.only_lowercased_letters(
            self.test_phrase)
    ...
    def test_lemmas_phrase(self):
        ...
        lowercase_phrase = self.preprocessing.only_lowercased_letters(
            self.test_phrase)
        important_words = self.preprocessing.remove_stopwords(
            lowercase_phrase)

        lemmas = self.preprocessing.lemmatize(
            important_words, tokenized_phrase)
    ...
    def test_fails_if_stop_words_are_not_removed_correctly(self):
        ...
        lowercase_phrase = self.preprocessing.only_lowercased_letters(
            self.test_phrase)
        actual_phrase = self.preprocessing.remove_stopwords(
            lowercase_phrase)
